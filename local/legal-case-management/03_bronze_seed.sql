...
DELETE FROM legal.bronze.raw_cases WHERE 1=1;

INSERT INTO legal.bronze.raw_cases (case_id, case_number, case_type, court, filing_date, close_date, status, priority, ingested_at)
VALUES
...
DELETE FROM legal.bronze.raw_parties WHERE 1=1;

INSERT INTO legal.bronze.raw_parties (party_id, party_name, party_type, ssn, contact_email, contact_phone, organization, jurisdiction, ingested_at)
VALUES
...
DELETE FROM legal.bronze.raw_attorneys WHERE 1=1;

INSERT INTO legal.bronze.raw_attorneys (attorney_id, attorney_name, bar_number, practice_group, partner_flag, years_experience, hourly_rate, ingested_at)
VALUES
...
DELETE FROM legal.bronze.raw_billings WHERE 1=1;

INSERT INTO legal.bronze.raw_billings (billing_id, case_id, attorney_id, billing_date, hours, hourly_rate, amount, billable_flag, billing_type, description, ingested_at)
VALUES
...
DELETE FROM legal.bronze.raw_relationships WHERE 1=1;

INSERT INTO legal.bronze.raw_relationships (relationship_id, source_id, target_id, source_type, target_type, relationship_type, weight, effective_date, ingested_at)
VALUES
