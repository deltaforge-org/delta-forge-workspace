...
DELETE FROM ehr.bronze.raw_departments WHERE 1=1;

INSERT INTO ehr.bronze.raw_departments (department_code, department_name, floor, wing, ingested_at) VALUES
...
DELETE FROM ehr.bronze.raw_diagnoses WHERE 1=1;

INSERT INTO ehr.bronze.raw_diagnoses (diagnosis_code, description, category, severity, ingested_at) VALUES
...
DELETE FROM ehr.bronze.raw_patients WHERE 1=1;

INSERT INTO ehr.bronze.raw_patients (patient_id, patient_name, ssn, date_of_birth, email, address, city, state, insurance_id, insurance_name, ingested_at) VALUES
...
DELETE FROM ehr.bronze.raw_admissions WHERE 1=1;

INSERT INTO ehr.bronze.raw_admissions (record_id, patient_id, department_code, diagnosis_code, admission_date, discharge_date, total_charges, attending_physician, notes, ingested_at) VALUES
