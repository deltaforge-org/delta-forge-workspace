...
| 5 | telecom-cdr | Telecom | Schema evolution lifecycle (v1 to v2 to v3 + type widening) + session windows + churn scoring | 14 | 14 |
...
| 13 | supply-chain-analytics | Supply Chain | **Split-file pattern**: INCLUDE SCRIPT per step + procurement to warehouse to transport to demand pipeline | 20 | 15 |
