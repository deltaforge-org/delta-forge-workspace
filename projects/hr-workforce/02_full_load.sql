...
-- ===================== STEP 1: Bronze -> Silver (Initial SCD2 Employee Dimension) =====================
...
-- ===================== STEP 2: SCD2 Two-Pass MERGE (Expire Old + Insert New) =====================
-- Process all non-hire events that change department, position, or salary
...
-- ===================== STEP 3: Bronze -> Silver (Comp Events Enrichment) =====================
...
-- ===================== STEP 4: Silver -> Gold (dim_department) =====================
...
-- ===================== STEP 5: Silver -> Gold (dim_position) =====================
...
-- ===================== STEP 6: Silver -> Gold (dim_employee from SCD2) =====================
...
-- ===================== STEP 7: Silver -> Gold (fact_compensation_events) =====================
...
-- ===================== STEP 8: Silver -> Gold (kpi_workforce_analytics) =====================
...
-- ===================== STEP 9: Deletion Vectors Demo =====================
-- Terminated employee EMP-005 requests full data erasure
