...
PIPELINE ecommerce_bronze_seed
...
DELETE FROM ecom.bronze.raw_customers WHERE 1=1;

INSERT INTO ecom.bronze.raw_customers (customer_id, email, first_name, last_name, segment, city, state, country, address, loyalty_tier, registration_date, source_system, ingested_at) VALUES
...
DELETE FROM ecom.bronze.raw_products WHERE 1=1;

INSERT INTO ecom.bronze.raw_products (product_id, sku, product_name, category, subcategory, brand, unit_cost, list_price, weight_kg, ingested_at) VALUES
...
DELETE FROM ecom.bronze.raw_web_orders WHERE 1=1;

INSERT INTO ecom.bronze.raw_web_orders (order_id, customer_id, product_id, quantity, unit_price, discount_pct, shipping_cost, order_date, status, session_id, browser, ingested_at) VALUES
...
DELETE FROM ecom.bronze.raw_mobile_orders WHERE 1=1;

INSERT INTO ecom.bronze.raw_mobile_orders (order_id, customer_id, product_id, quantity, unit_price, discount_pct, shipping_cost, order_date, status, session_id, app_version, ingested_at) VALUES
...
DELETE FROM ecom.bronze.raw_pos_orders WHERE 1=1;

INSERT INTO ecom.bronze.raw_pos_orders (order_id, customer_id, product_id, quantity, unit_price, discount_pct, shipping_cost, order_date, status, store_id, terminal_id, ingested_at) VALUES
...
DELETE FROM ecom.bronze.raw_browsing_events WHERE 1=1;

INSERT INTO ecom.bronze.raw_browsing_events (event_id, customer_id, session_id, event_type, event_ts, page_url, product_id, ingested_at) VALUES
