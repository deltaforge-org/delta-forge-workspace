...
-- ===================== STEP 2: merge_multi_source_orders =====================
...
STEP merge_multi_source_orders
...
-- ===================== STEP 3: segment_customers (RFM with NTILE) =====================
...
-- ===================== STEP 4: build_sessions (funnel sessionization) =====================
...
-- ===================== STEP 9: build_fact_order_lines =====================

STEP build_fact_order_lines
...
-- ===================== STEP 12: materialize_inventory_cdf =====================
