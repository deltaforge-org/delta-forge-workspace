...
DROP PSEUDONYMISATION RULE ON {{zone_prefix}}.silver.incidents_correlated (source_ip);
...
DROP DELTA TABLE IF EXISTS {{zone_prefix}}.bronze.raw_alerts WITH FILES;
DROP DELTA TABLE IF EXISTS {{zone_prefix}}.bronze.raw_rules WITH FILES;
DROP DELTA TABLE IF EXISTS {{zone_prefix}}.bronze.raw_targets WITH FILES;
DROP DELTA TABLE IF EXISTS {{zone_prefix}}.bronze.raw_source_ips WITH FILES;
