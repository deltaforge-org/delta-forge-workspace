...
-- ===================== STEP 2: Bronze -> Silver (Dedup + Correlate + Enrich) =====================
...
-- Should be significantly less than 75 raw alerts
...
-- ===================== STEP 4: Silver -> Gold Fact Incidents =====================
...
-- ===================== STEP 5: Gold KPI - Hourly Threat Dashboard =====================
...
-- ===================== STEP 6: Optimize with Bloom Filters =====================
