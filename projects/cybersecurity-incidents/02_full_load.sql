...
STEP dedup_5min_windows
  DEPENDS ON (merge_firewall, merge_ids, merge_endpoint)
  TIMEOUT '3m'
AS
...
-- ===================== STEP 8: build dimensions (parallel) =====================
