...
-- ===================== STEP 2: Bronze -> Silver Accounts (CDF-enabled) =====================
...
-- ===================== STEP 3: Bronze -> Silver Transactions (Enrich + Fraud Score) =====================
...
-- ===================== STEP 6: Gold KPI - Daily Volumes with 7-day Moving Average =====================
