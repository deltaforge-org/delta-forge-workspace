-- ============================================================================
-- WWI Data Lake - Bronze Sales (Incremental)
-- ============================================================================
-- Incremental ingestion of Sales schema transactional tables.
-- 7-day overlap: always re-fetches the last 7 days from source regardless
-- of whether data changed, then MERGE upserts to handle duplicates.
...
-- Orders (watermark on last_edited_when)
...
-- Order Lines (watermark on last_edited_when)
...
-- Invoices (watermark on last_edited_when)
...
-- Invoice Lines (watermark on last_edited_when)
...
-- Customer Transactions (watermark on last_edited_when)
