...
STEP enrich_claims
  DEPENDS ON (insert_scd2_policies)
  TIMEOUT '5m'
AS
...
STEP build_fact_claims
  DEPENDS ON (build_dim_claimant, build_dim_adjuster, insert_scd2_policies)
  TIMEOUT '5m'
AS
