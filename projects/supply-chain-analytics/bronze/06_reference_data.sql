...
-- Suppliers (6)
-- -------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS sc.bronze.suppliers (
  supplier_id       STRING,
...
-- Warehouses (4)
-- -------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS sc.bronze.warehouses (
  warehouse_id    STRING,
...
-- -------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS sc.bronze.products (
  sku             STRING,
  product_name    STRING,
  category        STRING,
  subcategory     STRING,
...
-- -------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS sc.bronze.stores (
  store_id        STRING,
  store_name      STRING,
  city            STRING,
  state           STRING,
