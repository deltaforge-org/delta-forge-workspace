...
DELETE FROM tax.bronze.raw_jurisdictions WHERE 1=1;

INSERT INTO tax.bronze.raw_jurisdictions (jurisdiction_id, jurisdiction_name, jurisdiction_level, state, base_tax_rate, standard_deduction, ingested_at)
VALUES
...
DELETE FROM tax.bronze.raw_preparers WHERE 1=1;

INSERT INTO tax.bronze.raw_preparers (preparer_id, preparer_name, firm, certification, years_experience, ingested_at)
VALUES
...
DELETE FROM tax.bronze.raw_taxpayers WHERE 1=1;

INSERT INTO tax.bronze.raw_taxpayers (taxpayer_id, taxpayer_name, ssn, filing_type, state, dependent_count, annual_income, ingested_at)
VALUES
...
DELETE FROM tax.bronze.raw_filings WHERE 1=1;

INSERT INTO tax.bronze.raw_filings (filing_id, taxpayer_id, jurisdiction_id, preparer_id, fiscal_year, filing_date, gross_income, deductions, taxable_income, tax_owed, tax_paid, refund_amount, filing_status, filing_type, notes, ingested_at)
VALUES
  -- ===== FY 2022 (20 filings) =====
...
DELETE FROM tax.bronze.raw_amendments WHERE 1=1;

INSERT INTO tax.bronze.raw_amendments (amendment_id, original_filing_id, taxpayer_id, amendment_date, amended_gross_income, amended_deductions, amended_taxable_income, amended_tax_owed, amendment_reason, preparer_id, ingested_at)
VALUES
