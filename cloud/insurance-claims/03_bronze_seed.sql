...
DELETE FROM ins.bronze.raw_adjusters WHERE 1=1;

INSERT INTO ins.bronze.raw_adjusters (adjuster_id, name, specialization, years_experience, region, ingested_at) VALUES
...
INSERT INTO ins.bronze.raw_claimants (claimant_id, name, ssn, date_of_birth, age_band, state, risk_tier, ingested_at) VALUES
...
DELETE FROM ins.bronze.raw_policies WHERE 1=1;

INSERT INTO ins.bronze.raw_policies (policy_id, holder_name, ssn, coverage_type, annual_premium, region, state, risk_score, effective_date, change_type, ingested_at) VALUES
...
DELETE FROM ins.bronze.raw_claims WHERE 1=1;

INSERT INTO ins.bronze.raw_claims (claim_id, policy_id, claimant_id, adjuster_id, incident_date, reported_date, claim_amount, approved_amount, status, settlement_date, description, ingested_at) VALUES
...
-- =============================================================================
-- ASSERT all row counts at end of pipeline
-- =============================================================================
