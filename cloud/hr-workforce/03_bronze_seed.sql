...
DELETE FROM hr.bronze.raw_departments WHERE 1=1;

INSERT INTO hr.bronze.raw_departments (department_id, department_name, division, cost_center, head_count_budget, annual_budget, manager_name, ingested_at)
VALUES
...
DELETE FROM hr.bronze.raw_positions WHERE 1=1;

INSERT INTO hr.bronze.raw_positions (position_id, title, job_family, job_level, pay_grade_min, pay_grade_max, exempt_flag, ingested_at)
VALUES
...
DELETE FROM hr.bronze.raw_employees WHERE 1=1;

INSERT INTO hr.bronze.raw_employees (employee_id, employee_name, ssn, email, date_of_birth, gender, hire_date, termination_date, department_id, position_id, education_level, status, ingested_at)
VALUES
...
DELETE FROM hr.bronze.raw_comp_events WHERE 1=1;

INSERT INTO hr.bronze.raw_comp_events (event_id, employee_id, department_id, position_id, event_date, event_type, base_salary, bonus, performance_rating, notes, ingested_at)
VALUES
  -- === 20 HIRE EVENTS ===
...
-- ===================== ASSERT: Verify all bronze seed tables =====================
